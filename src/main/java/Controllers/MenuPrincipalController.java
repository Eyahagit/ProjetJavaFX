...
public class MenuPrincipalController {
    ...
    private Service.ServiceCabinet serviceCabinet = new Service.ServiceCabinet();
    private Service.ServicePsychologue servicePsychologue = new Service.ServicePsychologue();
    private Service.ServiceRendezVous serviceRendezVous = new Service.ServiceRendezVous();
