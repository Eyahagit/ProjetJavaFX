...
import com.santebienetre.service.ai.AnonymousSessionService;
import com.santebienetre.service.ai.AnonymousWellnessAssessmentAI;
...
public class AnonymousWellnessController {
    ...
    private void showResults(AnonymousWellnessAssessment assessment) {
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/AnonymousWellnessResults.fxml"));
